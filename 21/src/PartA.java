...
public class PartA {
	...
	private static HashMap<String, Integer> ingredientTotal = new HashMap<>();
	...
	public static void main(String[] args) {
        ...
        while(sc.hasNext()) {
        	...
        	for (String ingredient : ingredientArray) {
				...
				if (ingredientTotal.containsKey(ingredient)) {
					ingredientTotal.put(ingredient, ingredientTotal.get(ingredient) + 1); 
				} else {
					ingredientTotal.put(ingredient, 1);
				}
        	}
        ...
        int total = 0;
        for (String ingredient : unmappedIngredients) total += ingredientTotal.get(ingredient);
